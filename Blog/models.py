...
class AccessLog(models.Model):
    ...
    duration = models.DecimalField(max_digits=10, decimal_places=3, null=True, blank=True, verbose_name='处理时长')
    ...
    language = models.CharField(max_length=50, null=True, blank=True, verbose_name='语言')
    ...
    district = models.CharField(max_length=50, null=True, blank=True, verbose_name='县区')
    ...
    source_type = models.CharField(max_length=255, null=True, blank=True, verbose_name='来源类型')
    user_agent_parsed = models.JSONField(null=True, blank=True, verbose_name='添加解析后用户代理字符串')
    extra_info = models.JSONField(null=True, blank=True, verbose_name='额外信息')
    referer_type = models.CharField(max_length=50, null=True, blank=True, verbose_name='来源类型')
    click_position = models.CharField(max_length=255, null=True, blank=True, verbose_name='点击位置')
    click_url = models.CharField(max_length=255, null=True, blank=True, verbose_name='点击URL地址')
    referrer_domain = models.CharField(max_length=100, null=True, blank=True, verbose_name='来源站点域名')
    session_start_time = models.DateTimeField(auto_now_add=True, null=True, blank=True, verbose_name="会话开始时间")
    session_end_time = models.DateTimeField(null=True, blank=True, verbose_name="会话结束时间")
    session_duration = models.FloatField(null=True, blank=True, verbose_name="会话持续时长(秒)")
    user_behavior = models.CharField(max_length=50, null=True, blank=True, verbose_name='用户操作行为')
